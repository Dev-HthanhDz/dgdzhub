...
local function NotificacaoNightMystic(titulo, mensagem)
    ...
    if not success then
        warn("DuongDz Hub] Erro ao exibir notificação")
    end
end
...
-- GỌI THỬ ĐỂ TEST:
-- ==========================================
NotificacaoNightMystic("DuongDz Notification 🔔", "New Update v4.0🔥")
task.wait(0.8)
NotificacaoNightMystic("DuongDz Thông Báo 🔔", "Cập Nhật Mới v4.0🔥")
...
local Window = redzlib:MakeWindow({
    Title = "DuongDz Hub : Blox Fruit",
    SubTitle = "by ",
    SaveFolder = true,
    Image = "93208708256226"
})
-- Tạo nút bấm bằng hàm gốc của thư viện (100% không lỗi ẩn/hiện)
local MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        Image = "rbxassetid://93208708256226", -- Dùng ID ảnh bạn chọn
        BackgroundTransparency = 1,
        Name = "DuongDz_On_Top_V5.2.0.0.0.0.1" -- Đặt tên đúng yêu cầu
    },
...
Discord:AddDiscordInvite({
    ...
    Logo = "rbxassetid://93208708256226",
    Invite = "https://discord.gg/XxAcsdYQ"
})
spawn(function()
    pcall(function()
        while wait() do
